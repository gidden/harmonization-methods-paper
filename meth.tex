...
case for CO2 in future scenarios with high mitigation strategies. 
...
determined for historical data aggregated to 11 world regions \TODO{list regions
  for 11 regions}. A threshold value of 10 has been chosen based on the
11-region observations, but, importantly, any regional aggregation is possible
as this is model depedent.
...
the historic and model values in the harmonization year.


\subsection{Implemented Methods}\label{sec:impl-meths}
