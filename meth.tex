...
initial time step $t_i$, a harmonized trajectory can be calculated. The
``goodness of fit'' of a trajectory depends on a number of factors, most notably
the faithful representation of the original, unharmonized, trajectory. However,
other important factors must be considered, such the representation of negative
