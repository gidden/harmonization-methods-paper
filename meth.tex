...
% * <sfujimori112256@gmail.com> 2017-05-24T21:26:14.081Z:
% 
% I am not sure but here my preference is stating from a kind of principle of the harmonization direction, which may be overview of the method in other words. More concretely, I would explain what we want to have after applying the methodology. 
% 1) Keep the model output trajectory as much as possible
% 2) we have to consider the CoV, dH and possibility of nagative emissions because brabra.
% .....  
% 
% ^.
...
The \code{aneris} code base provides a number of methods to choose from for each
