...
% * <sfujimori112256@gmail.com> 2017-06-07T10:12:45.308Z:
% 
% Maybe it would be better to add an explanation why we allow this option like
% "We allow this overriding option because the default method do not meet our criteria sometimes (but usually very few cases)"
% 
% ^.
...
aggregation of common analysis regions is performed (e.g., the 5 RCP
regions). Finally, any exogenous trajectories the user provides are
% * <sfujimori112256@gmail.com> 2017-06-07T10:17:07.935Z:
% 
% > (e.g., the 5 RCP
% > regions) 
% It might be good to show what is 5 regions (or definition) in the SM.
% 
% ^.
