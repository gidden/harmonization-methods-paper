...
The emissions trajectories calculated by \glspl{iam} are critical inputs for ongoing,
...
of marker SSP scenarios developed by the \gls{iam} community (ScenarioMIP)
...
Representative Concentration Pathways (RCPs), \gls{iam} results have been harmonized
...
\gls{iam} values used in the SSP and (ongoing) CMIP6 inter-comparison
