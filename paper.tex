...
trajectories were harmonized for each scenario, and therefore 1940 trajectories
were harmonized in total for these two illustrative scenarios.  \noxx generated
from the Energy sector provides an example of an emissions species and sector in
which all regions were satisfactorily harmonized with the default
...
regional trajectories for both the reference and mitigation scenarios that match
the general unharmonized model behavior and also result in global aggregated
emissions that are similar to the unharmonized trajectory.
