...
trajectories.
% * <sfujimori112256@gmail.com> 2017-06-07T10:22:28.473Z:
% 
% As a supplementary, it would be better to show the total kyoto gases emissions for these two scenarios, which gives readers rough image what kind of scenarios we choose.
% 
% ^.
...
% * <sfujimori112256@gmail.com> 2017-06-07T10:24:05.117Z:
% 
% > omprise 10
% > separate pollutant and GHG species and 13 sectors. Therefore, a total of 1430
% > distinct trajectories were harmonized for each scenario.
% 
% We may be better to show full list of sectors and species which we dealt with.
% 
% ^.
separate pollutant and GHG species and 13 sectors. Therefore, a total of 1430
distinct trajectories were harmonized for each scenario.
...
2\% required the use of harmonization overrides after an initial investigation;
...
% * <sfujimori112256@gmail.com> 2017-06-07T10:28:41.326Z:
% 
% > regional trajectories whose
% > \textit{magnitude} was overly distorted and regional trajectories whose
% > \textit{shape} was overly distorted.
% 
% How can we detect these results?
% If we could have a systematic detection criteria, then it would be really worthwhile to describe.
% Otherwise, it means that the users of this tool generally  have to see all results by their eye, which could be essentially a weak point of this tool.
% If so, we may want to discuss that point in the discussion section,
% 
% ^.
\textit{magnitude} was overly distorted and regional trajectories whose
\textit{shape} was overly distorted.
