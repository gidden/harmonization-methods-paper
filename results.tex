...
% * <maarten.vandenberg@pbl.nl> 2017-07-03T22:41:59.852Z:
% 
% >  which comprise 10
% > separate pollutant and GHG species and 13 sectors shown in Table
% Do we correctly distinguish between the regional and global values (N2O)? The table mentions a sector "Unharmonized", which is the sector-aggregated value I assume, which also might lead to overcounting. In the table I would change this sector naming.
% 
% ^.
